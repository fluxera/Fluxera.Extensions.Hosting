namespace Fluxera.Extensions.Hosting
{
	...
	public static class WebHostBuilderExtensions
	{
		...
		/// <returns></returns>
		public static IWebHostBuilder ConfigureFoundationDefaults(this IWebHostBuilder hostBuilder)
		{
		...
		/// <returns></returns>
		public static IWebHostBuilder ConfigureHostBuilder(this IWebHostBuilder hostBuilder, Action<IWebHostBuilder> configureBuilder)
		{
		...
		/// <returns></returns>
		public static IWebHostBuilder ConfigureApplicationLoader<TStartupModule>(this IWebHostBuilder hostBuilder,
			ILogger logger,
